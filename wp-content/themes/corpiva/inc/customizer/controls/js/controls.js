...
( function( api ) {
	...
	// Extends our custom "corpiva" section.
	api.sectionConstructor['corpiva'] = api.Section.extend( {
...
jQuery(document).ready(function($) {
	 jQuery("#sub-accordion-section-corpiva_sidebar_options select:not(#_customize-input-corpiva_default_pg_sidebar_option), #sub-accordion-section-corpiva_typography_options select, #sub-accordion-section-corpiva_headings_typography select").prop('disabled', true);
});
