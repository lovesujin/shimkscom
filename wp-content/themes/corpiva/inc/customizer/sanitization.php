 ...
 */
function corpiva_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function corpiva_sanitize_html( $html ) {
 ...
 */
function corpiva_sanitize_select( $input, $setting ) {
 ...
 */
function corpiva_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function corpiva_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function corpiva_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}